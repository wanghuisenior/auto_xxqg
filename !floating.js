...
let window = floaty.window(
    <vertical>
        <button id="move" text=" 长按拖动 " w="90" h="35" bg="#77ffffff" textSize="10sp" />
        <button id="goodStudy" text=" 一键学习 " w="90" h="35" bg="#77ffffff" textSize="10sp" />
        <button id="startDT" text=" 手动答题 " w="90" h="35" bg="#77ffffff" textSize="10sp" />
...
//window.setPosition(deviceWidth * 0.65, deviceHeight * 0.54);
window.setPosition(deviceWidth * 0.05, deviceHeight * 0.02);
setInterval(() => {
}, 1000);
